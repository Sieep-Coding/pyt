...
from backend.database import add_contact, add_lead
...
def add_contact_window():
    ...
    tk.Button(add_window, text="Add Contact", command=submit_new_contact,
...
def add_lead_window():
    ...
    tk.Button(add_window, text="Add Lead", command=submit_new_lead,
              padx=10, pady=5).grid(row=6, column=0, columnspan=2, pady=20)
